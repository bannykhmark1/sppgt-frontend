    ...
    <header className="fixed mb-24 top-0 z-10 w-full">
      <nav className="w-full bg-yellow-400 shadow fixed z-20">
        <div className="justify-around container mx-auto px-4 md:px-0 md:items-center md:flex">
          ...
          <div className={`container flex-1 justify-between pb-3 mt-8 md:block md:pb-0 md:mt-0 ${menuOpen ? "block" : "hidden"}`}>
            <ul className="items-center justify-between space-y-8 md:flex md:space-x-6 md:space-y-0">
              ...
              <li className="text-black hover:text-orange-600 mt-3  md:mt-0">
                <button
                  type="button"
                  className="text-white bg-orange-500 mr-4 md:mb-0 mb-4 font-medium hover:bg-orange-600 rounded-lg text-sm px-4 py-2 w-full md:w-auto"
              ...
              {user.isAuth ? (
                <>
                  {user.user.role === 'ADMIN' && (
                      ...
                      <button
                        className="text-white bg-orange-500 md:mb-0 md:mr-4 mb-4 font-medium hover:bg-orange-600 rounded-lg text-sm px-4 py-2 w-full md:w-auto"
